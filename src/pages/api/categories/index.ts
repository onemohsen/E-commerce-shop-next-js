...
export default function handler(
  ...
  let filterDataInstance = new FilterDataClass<Category>(getData(imageQuilty!), { ...req.query });

  let { data, meta }: { data: Category[] | [], meta: MetaRespone } = filterDataInstance.get();
...
const getData = (imageQuilty: string) => [
  ...
  { id: 2, name: "Electronics", image: `https://picsum.photos/id/2/${imageQuilty}` },
  { id: 3, name: "Smartphones", image: `https://picsum.photos/id/3/${imageQuilty}` },
  { id: 4, name: "Modern tech", image: `https://picsum.photos/id/4/${imageQuilty}` },
